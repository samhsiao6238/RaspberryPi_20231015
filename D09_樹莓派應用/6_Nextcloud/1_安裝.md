...
14. 可設定預設版本，在 `2023/12/06` 時又更新到 `8.3` 了。
...
30. 確保目錄「/var/www/html/nextcloud」和其子目錄的權限至少為 755
...
31. 確保「www-data」（或Web伺服器的用戶）是「/var/www/html/nextcloud」和其子目錄的擁有者
