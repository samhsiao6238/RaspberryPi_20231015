...
3. 修改白名單，將 `'192.168.1.134:8080'` 加入可確保即使 Nextcloud 在非標準連接埠上運行，也能正確地識別和允許存取。。
...
4. 修改 Nextcloud 的基礎 URL，所有從 Nextcloud 產生的絕對 URL 都將以這個位址為基礎。
